...
lt-if-then-else-4:                                ; preds = %lt-tail-3, %lt-tail-2, %lt-tail-0
  ...
  br i1 %24, label %lt-clone-2-4, label %lt-clone-2-4

lt-clone-2-4:                                     ; preds = %lt-if-then-else-4, %lt-if-then-else-4
  br label %lt-tail-4

lt-tail-4:                                        ; preds = %lt-clone-2-4
  ret i32 %result.1
}
